define(['skbJet/component/resourceLoader/resourceLib', 'skbJet/componentManchester/standardIW/splash/splashLoadController'], function(
  ...
  function onResize() {
    var bgImg =
      window.innerWidth > window.innerHeight
        ? resLib.splash.background_landscape
        : resLib.splash.background_portrait;
  ...
  function onLoadSplashDone() {
    ...
    loaderContainer.appendChild(resLib.splash.Logo_loader_portrait);
    resLib.splash.Logo_loader_portrait.className = 'loaderImage';
